...
namespace AindInformationForagingDataSchema.AindBehaviorInformationForagingSession
{
    ...
    public partial class AindInformationForagingSession
    {
    
        private string _describedBy = "https://raw.githubusercontent.com/AllenNeuralDynamics/Aind.Behavior.InformationForaging/main/src/DataSchemas/aind_behavior_information_foraging_session.json";
        ...
        public AindInformationForagingSession()
        {
        }
    
        protected AindInformationForagingSession(AindInformationForagingSession other)
        {
        ...
        public System.IObservable<AindInformationForagingSession> Process()
        {
            return System.Reactive.Linq.Observable.Defer(() => System.Reactive.Linq.Observable.Return(new AindInformationForagingSession(this)));
        }
    
        public System.IObservable<AindInformationForagingSession> Process<TSource>(System.IObservable<TSource> source)
        {
            return System.Reactive.Linq.Observable.Select(source, _ => new AindInformationForagingSession(this));
        }
    ...
    public partial class SerializeToJson
    {
        ...
        public System.IObservable<string> Process(System.IObservable<AindInformationForagingSession> source)
        {
            return Process<AindInformationForagingSession>(source);
        }
    }
    ...
    [Bonsai.WorkflowElementCategoryAttribute(Bonsai.ElementCategory.Transform)]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(Bonsai.Expressions.TypeMapping<AindInformationForagingSession>))]
    public partial class DeserializeFromJson : Bonsai.Expressions.SingleArgumentExpressionBuilder
    {
    
        public DeserializeFromJson()
        {
            Type = new Bonsai.Expressions.TypeMapping<AindInformationForagingSession>();
        }
