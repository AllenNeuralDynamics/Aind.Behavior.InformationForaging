...
def main():
    models = {
        "aind_behavior_information_foraging_task": aind_behavior_information_foraging.task_logic.schema(),
        "aind_behavior_information_foraging_session": aind_behavior_information_foraging.session.schema(),
        "aind_behavior_information_foraging_rig": aind_behavior_information_foraging.rig.schema(),
    }
